//
// Generated file, do not edit! Created by opp_msgtool 6.0 from physicallayer/radio/SignalDescriptor.msg.
//
...
double SignalDescriptor::getRssi() const
{
    return this->rssi;
}

void SignalDescriptor::setRssi(double rssi)
{
    this->rssi = rssi;
}
